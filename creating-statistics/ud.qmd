...
* The data file should have an accompanying [meta-data csv file](#ees-metadata), which contains information on the nature of the columns in the data file:
  ...
  * number of decimal places to display for indicator fields (i.e. allowing a lower precision to be presented in the derived tables than the underlying data - useful for minimising rounding errors in aggregates);
