...
Shiny is an R package that makes it easy to build interactive web apps straight from R. You can host standalone apps on a webpage, embed them in [R Markdown documents](http://rmarkdown.rstudio.com/) or build dashboards. You can also extend your Shiny apps with [CSS themes](http://rstudio.github.io/shinythemes/), [htmlwidgets](http://www.htmlwidgets.org/), and [JavaScript actions](https://github.com/daattali/shinyjs/blob/master/README.md).
...
For some initial inspiration, check out the [Shiny gallery](https://shiny.posit.co/r/gallery/).
...
Our [template Shiny app repository](https://github.com/dfe-analytical-services/shiny-template) is a useful starting point for all public facing dashboards in the department. Please see the [dashboard template section](#dfe-styling-and-the-dfe-r-shiny-template) for guidance on what the dashboard template includes and how to use it.

[Shiny layouts](https://shiny.posit.co/r/layouts/) gives a high level idea of how to structure an R Shiny app. Alongside this it is recommended you take a look at [`bslib`](https://rstudio.github.io/bslib/index.html) which makes constructing beautiful user interfaces easy. This site is full of information on how to construct the page and how to work themeing.
...
- Your code should follow the [DfE Quality Assurance Framework](https://educationgovuk.sharepoint.com/sites/sarpi/g/SitePages/Quality-Assurance.aspx) 
- You need to [**Accessibility Test**](#accessibility-testing-in-r-shiny) regardless of internal or external deployment
...
- If using [databases with Shiny](#databases-with-shiny), you should use the pool package. You should also be conscious of SQL Injection which is where code could be maliciously used to attack a database backend - see [SQL injection prevention](https://shiny.posit.co/r/articles/build/sql-injections/) for best practice
...
- have a read of [Outstanding User Interfaces with Shiny](https://unleash-shiny.rinterface.com/welcome.html) for how the web stuff works with Shiny 
- for easy theme customisation [Bootstrap Live Customiser](https://www.bootstrap-live-customizer.com/) 
- for more context of the web bits, [HTML](https://www.w3schools.com/html/default.asp), [CSS](https://www.w3schools.com/css/default.asp) and [Bootstrap](https://www.w3schools.com/bootstrap/bootstrap_ver.asp) give a better understanding of what's under the hood. 
...
For **interactive maps**, refer to [this section on interactive maps](../learning-development/r.html#example-shiny-app-with-map).

For improving your **tables**, check out [this section on data tables](../learning-development/r.html#rendering-tables).
...
- The [Explore Education Statistics Platforms Team](mailto:explore.statistics@education.gov.uk) are experienced with R Shiny and happy to help or offer advice;
- The [DfE R community](https://teams.microsoft.com/l/team/19%3a311ec2e4d46b4dd38f0d61f05fb93383%40thread.skype/conversations?groupId=b95c605d-8fbc-4e4d-9a76-2f7d1c55e70a&tenantId=fad277c9-c60a-4da1-b5f3-b3b8b34a82f9) on Teams is a place where you can post things you've learned or to ask for help;
...
Which produces the following chart with tooltips appearing when the user hovers over any given data point (disabled temporarily whilst working on server updates):

``` {r ggiraph_run, echo=FALSE, eval=FALSE}
...
- Obtain authorisation via email from the relevant G6 or DD and the [explore education statistics platforms team](mailto:explore.statistics@education.gov.uk)
...
You must contact the explore education statistics platforms team for the following:
