...
- If using [databases](#databases-with-shiny), you should ensure you are careful of SQL Injection
...
On Posit Connect (so internal dashboards only), a process is started up when a user opens your application. The process loads everything in your global environment (pre-server). These environment variables can then be shared between users with up to 20 users sharing a process by default. This can massively save on computation time.
...
- have a read of [Outstanding User Interfaces with Shiny](https://unleash-shiny.rinterface.com/welcome.html) for how the web stuff wortks with shiny 
- for easy theme customisation [Bootstrap Live Customiser](https://www.bootstrap-live-customizer.com/) 
- For more context of the web bits, [HTML](https://www.w3schools.com/html/default.asp), [CSS](https://www.w3schools.com/css/default.asp) and [Bootstrap](https://www.w3schools.com/bootstrap/bootstrap_ver.asp) for a better understanding of what's under the hood. **This is a slippery slope into web development, remember that if you're working with Shiny then good analysis comes first!**

For making interactive maps, check out [this section](../learning-development/r.html#example-shiny-app-with-map).
...
---
=======
>>>>>>> db8ab75 (update: header levels and best practice checklist)
