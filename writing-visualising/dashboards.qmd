...
# Creating a public facing R-Shiny dashboard
...
## Where to host your dashboard code
...
### Procedure for a statistics (or statistics + development) update to your R-Shiny dashboard
...
- Contact the [Statistics Development Team](mailto:statistics.development@education.gov.uk) providing the following:
  ...
  - ask us to run a review & health check on your dashboard to make sure it's up to date with standards and is in a state to successfully deploy
...
#### Adding general improvements not connected to new data

---

- Create individual branches for specific improvements
- Create / update UI tests for any new / changed functionality / behaviour
- Merge these into a central development branch or into your main branch as each work item is completed

---

#### Prior to publication day

---

- Create a new update branch on GitHub (branching from the most up to date version of your dashboard - i.e. either the main branch or the development branch if you've been making new updates on a development branch) where you intend to place your updates
- Create a Pull Request between that branch and main (or development if you wish to test on development first)
- Pull the new update branch into your local clone of the repo and add any new data and associated new functionality. Make the appropriate add / commits, but don't push this branch once you've got the new data in.
- Run the local tests and record associated updates to UI tests caused by new data and / or functionality
...
- Push the new update branch created above
...
#### Adding general code changes not connected to new data

---

Note that wherever possible dashboard development updates should be done separately from routine data updates.

- Create individual branches for specific areas of development
- Create / update UI tests for any changes to functionality
- Merge these into a central development branch or into your main branch as each work item is completed

---

### Procedure for a development only update to your R-Shiny dashboard

---

#### At beginning of the work

---

- Contact the [Statistics Development Team](mailto:statistics.development@education.gov.uk) providing:
  - an overview of planned developments for the dashboard
  - the contact details of the lead developer
  - the contact details of the lead reviewer
  - the contact details of the approver (G6)
  - ask us if it's necessary to run a review & health check on your dashboard to make sure it's up to date with standards and is in a state to successfully deploy
- Run an update of all R-packages used by the dashboard (`renv::update()`) to check that everything works as expected
...
- Create a Pull Request between your working branch and main (or development if you wish to test on development first)
- Run the local tests and record associated updates to UI tests caused by new data and / or functionality
- Verify all tests / checks pass on the pull request - fix if they don't
- Get approval on GitHub Pull Request from appropriate reviewer (e.g. G7)
- Complete the pull request to trigger the deploy
