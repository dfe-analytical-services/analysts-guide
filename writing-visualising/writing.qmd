...
Robert Cuffe from the BBC [led a session at the 2023 SRA annual conference](https://www.youtube.com/embed/WGTMRGQS7FM?controls=0) discussing highlighting key messages and how our publications are used by journalists and the media.

You can also find an interview with Robert in the Office for Statistics Regulation blog: [Making an impact: how can statisticians help journalists to answer key questions with data?](https://osr.statisticsauthority.gov.uk/blog/author/robert-cuffe/).
