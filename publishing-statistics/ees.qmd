...
1. The [public](https://explore-education-statistics.service.gov.uk/){target="_blank" rel="noopener noreferrer"} website, where users access stats

2. The [admin](https://admin.explore-education-statistics.service.gov.uk/){target="_blank" rel="noopener noreferrer"} website, where production teams create their stats
...
Publications are organised into topics and themes (as shown on the EES [Find Statistics page](https://explore-education-statistics.service.gov.uk/find-statistics){target="_blank" rel="noopener noreferrer"}), and then within each publication there are releases - where the latest release includes the latest statistics for that publication. For example:
