...
[Setup Databricks personal cluster with RStudio and `odbc` / `DBI`](ADA/databricks_rstudio_personal_cluster.html)
- Guidance for analysts on how to connect to a Databricks personal cluster from RStudio.

[Setup Databricks personal cluster with RStudio and `sparklyr`](ADA/databricks_rstudio_personal_cluster_sparklyr.html)
- Guidance for analysts on how to connect to a Databricks personal cluster from RStudio.
