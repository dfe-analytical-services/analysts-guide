...
[Databricks](learning-development/databricks.html)
- Guidance and tips for using Databricks
...
[RAP in statistics](RAP/rap-statistics/rap-statistics.html)
...
[Getting started with RAP](RAP/getting-started-with-rap.html)
...
[RAP in general analysis](RAP/rap-analysis/rap-analysis.html)
- Detailed RAP guidance for all other analytical work

[RAP expectations](RAP/rap-expectations.html)
- Guidance for all analysts on expectations of RAP

[RAP support](RAP/rap-support.html)
- Details on support available for RAP in DfE

[RAP Case studies](RAP/rap-case-studies.html)
- Case studies using RAP from across the department
...
[Migrating to Datarbricks](ADA/migrating_to_databricks.qmd)
- Guidance on different options for migrating processes to Databricks from SSMS 
...
[Scripting Databricks workflows](ADA/scripting_databricks_workflows.html)
- Guidance for scripting workflows in the Databricks interface

[Databricks medallion architecture (Bronze, Silver, Gold, Copper)](ADA/databricks_medallion_architecture.qmd)
- De-mystifying the 'medallion architecture' pattern and what the bronze, silver, gold and copper catalogs mean.
