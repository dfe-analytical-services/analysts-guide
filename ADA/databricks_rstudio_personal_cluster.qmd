...
Note: Databricks have recently renamed their ODBC driver which may cause issues with the `odbc` R package while it catches up. We've added a line to the code above to specify the driver, which provides a fix in the meantime.
