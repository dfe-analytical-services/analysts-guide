---
  title: "Set up Databricks personal compute cluster with RStudio and `odbc` / `DBI`"
---
...
Within the Databricks environment they are able to use SQL, R, Python and Scala, and are more flexible than SQL Warehouses. However, using this ODBC method from RStudio you will only be able to query data using SQL as you would have done previously when connecting to Microsoft SQL server.
