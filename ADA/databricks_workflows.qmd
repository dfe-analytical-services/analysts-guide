...
For instructions on how to use the Databricks SDK for R package to script workflows see the [Scripting Databricks workflows](scripting_databricks_workflows.qmd) page.
