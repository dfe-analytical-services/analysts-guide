...
DATABRICKS_SQL_PATH="/sql/1.0/warehouses/abcdefgh123"
:::
...
The Databricks SQL Path is the location of the warehouse containing data that you would like to use. To get the warehouse ID, follow these steps:
