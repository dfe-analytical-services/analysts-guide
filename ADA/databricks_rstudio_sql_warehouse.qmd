...
-   Setting up an ODBC driver on your laptop to enable a connection between your laptop and Databricks
...
To pull in your data, include the following code in your R Script:
