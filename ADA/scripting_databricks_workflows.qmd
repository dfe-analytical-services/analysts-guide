...
For this example we will create a folder in our workspace, create two test notebooks to comprise the workflow, and then script the job and set it off running - you can do this either from RStudio or by creating another Databricks notebook. We'll also set it up to notify us by email when the workflow successfully completes.

::: {.callout-tip collapse="true"}

# Scripting workflows using RStudio
