...
Step 1: You can change the default location for virtual environments using the WORKON_HOME setting.
...
Step 2: Set-up your databricks  follow the instructions at Set up Databricks personal compute cluster with RStudio – Analysts’ Guide and get to the point of connecting with:
...
1. First click on the dropdown (open image in new tab if too small):

<img src="/images/ADA/databricks_common_questions/workspace_dropdown_1.png" alt = "Workspace location" style = "width:75%;">

2. Navigating the dropdown:

<img src="/images/ADA/databricks_common_questions/workspace_dropdown_2.png" alt = "Workspace swapping between workspaces" style = "width:75%;">
...
<img src="/images/ADA/databricks_common_questions/workspace_dropdown_3.png" alt = "Workspace swapping between workspaces" style = "width:75%;">
...
<img src="/images/ADA/databricks_common_questions/catalog_dropdown_1.png" alt = "Catalog location" style = "width:75%;">

- and it should look like this:

<img src="/images/ADA/databricks_common_questions/catalog_dropdown_2.png" alt = "Catalog viewpoints" style = "width:75%;">
...
1. Find settings button after clicking your profile icon:
<img src="/images/ADA/databricks_common_questions/pat_token_1.png" alt = "Settings button" style = "width:75%;">

2. Navigate to settings:
<img src="/images/ADA/databricks_common_questions/pat_token_2.png" alt = "Workspace swapping between workspaces" style = "width:75%;">

3. Click developer:
<img src="/images/ADA/databricks_common_questions/pat_token_3.png" alt = "Workspace swapping between workspaces" style = "width:75%;">

4. Set-up token:
<img src="/images/ADA/databricks_common_questions/pat_token_4.png" alt = "Workspace swapping between workspaces" style = "width:75%;">
...
<img src="/images/ADA/databricks_common_questions/personal_compute_1.png" alt = "Catalog viewpoints" style = "width:75%;">
2. Create a new personal compute instance: 
<img src="/images/ADA/databricks_common_questions/personal_compute_2.png" alt = "Catalog viewpoints" style = "width:75%;">
3. Make sure to set the access mode to a form that includes R as a language: 
<img src="/images/ADA/databricks_common_questions/personal_compute_3.png" alt = "Catalog viewpoints" style = "width:75%;">
4. Swap to your personal compute: 
<img src="/images/ADA/databricks_common_questions/personal_compute_4.png" alt = "Catalog viewpoints" style = "width:75%;">
5. Click through: 
<img src="/images/ADA/databricks_common_questions/personal_compute_5.png" alt = "Catalog viewpoints" style = "width:75%;">
6. It should run: 
<img src="/images/ADA/databricks_common_questions/personal_compute_6.png" alt = "Catalog viewpoints" style = "width:75%;">
...
There’s a few different reasons why your code might no longer work.
...
- Square bracket identifiers [column] → backticks `column`
- + for string concatenation → CONCAT() or ||
- GETDATE() → CURRENT_TIMESTAMP()
DATEADD, DATEDIFF → DATE_ADD, DATEDIFF
