...
An example of setting up the connection and running queries can be found on the [Databricks SQL Warehouse with RStudio page](../ADA/databricks_rstudio_sql_warehouse.html#pulling-data-into-rstudio-from-databricks). This could then be wrapped in a reusable function to standardise connection handling and query execution. 

------------------------------------------------------------------------

*\*For all processes that run SQL code or read from / write to the Databricks catalog from outside Databricks, you’ll need to manually set up a connection to a Databricks compute resource. The best compute option for this is an SQL Warehouse, you can find more information on setting this up on our [Databricks SQL Warehouse with RStudio page](../ADA/databricks_rstudio_sql_warehouse.html).*
