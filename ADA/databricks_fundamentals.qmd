...
## Benefits of moving to Databricks

------------------------------------------------------------------------

Migration to Databricks offers a lot of potential benefits to analysts. These include:

- **Data Access** - All data, scripts and processes are available in a single place, reducing the need to work across multiple systems and tools.
- **Scalability** - Computing resources can be increased when needed, allowing larger datasets and more complex analyses to be processed without being limited by local hardware.
- **Automation** - Workflows can be scheduled to run automatically, reducing manual effort and supporting repeatable analytical processes.
- **Collaboration** - Notebooks, reports and analytical assets can be shared across teams, improving transparency and reducing duplication of work.
- **Governance** - Data and analytical assets are managed within a controlled environment, supporting secure access and compliance with departmental standards.
- **Auditability** - Changes to data, code and outputs are recorded, making it easier to reproduce analyses, investigate issues and understand how results were produced.
- **Standardisation** - Common datasets and shared resources can be maintained centrally, helping to improve consistency across analyses and publications.
- **Efficiency** - Less time is spent managing infrastructure and technical limitations, allowing analysts to focus on generating insights and delivering value.

------------------------------------------------------------------------

## Key elements of Databricks
...
The majority of data and files on Databricks should be stored in the 'unity catalog'. This is a governance layer that sits above workspaces to centrally manage data access, security, and metadata across them. This is similar in concept to a traditional database server, however the unity catalog also contains file storage in the form of volumes.
...
You can also run code from RStudio or other IDEs locally and execute it against the data held in Databricks. To do this, you will need to set up a connection between RStudio and the Databricks SQL Warehouse. This is explained in the [R scripts in RStudio section](https://dfe-analytical-services.github.io/analysts-guide/ADA/databricks_rstudio_sql_warehouse.html) below.
...
You can read more about workflows on our [Databricks workflows](/ADA/databricks_workflows.html) guidance page. 
...
## Skilling up on Databricks

There are many different learning resources available to develop your understanding of Databricks.

DataCamp has a number of courses that cover different aspects of Databricks. The [GSS Databricks Foundations](https://app.datacamp.com/learn/custom-tracks/custom-gss-track-9a-databricks-foundations-beginner) track is designed for new users, while the [GSS Databricks for Intermediate Practitioners](https://app.datacamp.com/learn/custom-tracks/custom-gss-track-9b-databricks-for-intermediate-practitioners) track is designed to build on users' understanding of the basics. DataCamp requires a licence - if you'd like a licence, please email datacamp.requests@education.gov.uk and copy in your line manager.

Databricks provides their own resources, including the [Databricks Fundamentals Course](https://www.databricks.com/training/catalog/databricks-fundamentals-2206) to introduce you to some of the key concepts.

There are monthly training workshops run by the ADA team. These are advertised on the [ADA user group Teams channel](https://teams.microsoft.com/l/team/19%3AGQW24K3V6M873QzUwpBIuyf8KZCxYByRawVsKQvpe-81%40thread.tacv2/conversations?groupId=c70bb59d-c5df-4af5-849f-36196ed14ba3&tenantId=fad277c9-c60a-4da1-b5f3-b3b8b34a82f9).
...
We recommend that you and your team engage with the platform as soon as possible so that you can learn at your own pace before you fully migrate
