...
The README in your repository is the place for traditional 'desk notes' and text explanations of bits of the process and context required, we have [guidance on writing READMEs on the statistics production website](rap-statistics.html#Writing_a_README_file).
