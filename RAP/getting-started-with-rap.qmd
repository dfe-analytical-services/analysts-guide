...
You can find guidance on how to implement the principles of Reproducible Analytical Pipelines into statistics production processes on the [RAP for statistics page](../RAP/rap-statistics.html). You can find guidance on how to implement RAP principles into general analysis on the [RAP for analysis page](../RAP/rap-analysis.html). 
...
2. Apply the relevant RAP principles from the [RAP for statistics page](../RAP/rap-statistics.html) or [RAP for analysis page](../RAP/rap-analysis.html). 
...
We have two sets of RAP principles to reflect the different needs of statistics production processes and general analysis. There are 15 core principles, which apply to both statistics and general analysis, and an additional four principles specific to statistics production processes.
...
The [RAP for general analysis principles](../RAP/rap-analysis.html) reflect that general analysis can be more varied, but still benefits from applying RAP principles proportionally. The RAP for analysis page has recommendations for how to apply RAP principles to different types of analysis.
