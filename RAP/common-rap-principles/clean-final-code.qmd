...
If you have code that was written in T-SQL (for example in SSMS), you may need to make some adjustments to the code to get it to run in Spark SQL. Take a look at the [what this means for exisitng code section on the ADA page](../../ADA/ada.html) for help with this.
