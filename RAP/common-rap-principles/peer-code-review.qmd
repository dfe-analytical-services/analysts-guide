...
Prior to receiving code for peer review, the author should ensure that all code files are clean, commented appropriately and for larger projects should be held in a repo with an appropriate [README](../../RAP/common-rap-principles/documentation.qmd#writing-a-readme-file) file.
