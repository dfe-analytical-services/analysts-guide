...
RAP principles can be applied proportionally to all analysis - they are simply best-practice when it comes to analysis and therefore we should all work towards RAP becoming our default way of working. Some principles are always applicable (like documentation, sensible folder/file structure) whereas others are applicable to more specific situations (such as ensuring code is recyclable and easily updated - this applies more to analysis that is likely to be re-run in future).
...
The process of gathering, cleaning, and organising raw data to ensure it is suitable for analysis. This includes sourcing data, resolving inconsistencies, standardising formats, and combining datasets.
