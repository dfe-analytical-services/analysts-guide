...
::: callout-note
RAP should be **proportional** to the analysis in the same way that [QA is proportional](https://educationgovuk.sharepoint.com/sites/sarpi/g/SitePages/Clearance-of-analysis.aspx). Statistics production has clearer expectations due to their regularity and commonalities between publication processing (see the [RAP in Statistics page](RAP/rap-statistics.html) for more information).
:::
