...
#### Best practice
- Whole pipeline can run from a single script or workflow
- Code collaboratively developed using Git
- Code stored in an appropriate repository
:::

::: {.callout-tip collapse="true"}
## Ad-hoc analysis (likley to be repeated e.g., different breakdowns)
...
- Peer review from someone outside the team 
 
:::

::: {.callout-tip collapse="true"}
## Internal irregular reporting

Non-routine analysis initiated within the department to address specific internal needs. It’s not part of scheduled reporting and may vary in format.
...
### More specific/advanced automated QA/summaries
...
Value is another one of the three pillars of our [code of practice](https://code.statisticsauthority.gov.uk/the-code/value/){target="_blank" rel="noopener noreferrer"}. Even more specifically it states that __'Statistics and data should be presented clearly, explained meaningfully and provide authoritative insights that serve the public good.'__. As a result, we should be developing automated summaries to help us to better understand the story of the data and be authoritative and rigorous in our telling of it.
...
### Code is stored in an appropriate repository
