...
<p class="text-muted">Guidance for how to implement the principles of Reproducible Analytical Pipelines (RAP) into statistics production processes. Check the [RAP for statistics page](../RAP/rap-statistics.html) for information on the core principles of RAP. </p>

---

Check your publication against the Good, Great and Best practice standards under [RAP in practice](/RAP/rap-statistics.html#rap-in-practice).
...
This section below is split by the three core principles, [preparing data], [writing code](#writing-code) and [version control].
