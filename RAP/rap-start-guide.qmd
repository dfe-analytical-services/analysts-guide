...
::: {.callout-note}
This section below is split by the three core principles, [preparing data], [writing code] and [documentation]. Within each of these principles are separate elements of RAP. Each of these is discussed in detail below so that you know what is expected of you as an analyst.
:::
