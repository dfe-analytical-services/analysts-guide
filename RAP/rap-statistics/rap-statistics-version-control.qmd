...
- Follow the guidance on [writing a readme file](../../RAP/common-rap-principles/documentation.qmd#writing-a-readme-file), and add context in about what Official/National statistics are
...
- Check your code is styled according the [tidyverse styling](../../RAP/common-rap-principles/clean-final-code.qmd)
...
A single repository should be used for all releases of your publication, there's no need to have multiple as all the history is saved within previous commits. You can make use of [tagging releases in Git](../../learning-development/git.qmd#tagging-release-versions) to help differentiate between each cycle.
