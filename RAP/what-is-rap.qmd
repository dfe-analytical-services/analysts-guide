...
RAP are a way of working that help analysts produce analysis that is consistent, reliable, and easy to update. They use code to automate processes and reduce manual steps, making sure everything is clearly documented. This approach, referred to as reproducible analysis, makes the it easier to understand, repeat and improve processes over time. 
