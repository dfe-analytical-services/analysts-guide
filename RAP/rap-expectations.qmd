...
We expect any analyst to know and be able to implement RAP principles, using the recommended tools to meet at least good and great practice. You can see examples of good, great and best practice on our [RAP for statistics principles](../RAP/rap-statistics.html) and [RAP for general analysis principles] pages. 
