...
We expect any analyst to know and be able to implement RAP principles, using the recommended tools to meet at least good and great practice. You can see examples of good, great and best practice on our [RAP for statistics principles](../RAP/rap-statistics.html) and [RAP for general analysis principles](../RAP/rap-analysis.html) pages. These pages set out the principles for statistics and analysis, and you should refer to the page most relevent to the work you are carrying out. 
