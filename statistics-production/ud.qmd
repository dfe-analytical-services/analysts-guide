...
Saving files in CSV format should be a standard from any analytical tool, though sometimes you need to watch out for how they are encoding special characters, for more information see the section on [how to export data with UTF8 encoding](#how-to-export-data-with-utf-8-encoding).
