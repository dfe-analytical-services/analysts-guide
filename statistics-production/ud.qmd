...
> Use of the word "gender" in data collections may have meant "gender identity" was reported in some cases as opposed to legal sex. While this is unlikely to have a significant effect on overall figures, it may affect figures in more granular subdivisions. The definitions used in the data collection were revised on [insert date relevant to the collection] and as such, time series spanning [insert date range] may be affected.
