...
- They can be truncated in analytics data, preventing us from aggregating data on the publication (anything over 66 characters starts to break this, 100 characters is completely unusable).
- They can hinder search engine optimisation (SEO), recommended to keep under 60 characters.
- They extend the length of URLs, making them unweildy and difficult to use.
- They can prevent downloads from working correctly, as some systems may not handle long URLs well and fail to open ZIP folders with long paths.
- They can be truncated in search results, making it harder for users to find the publication.
- They can be difficult to read and understand, especially for users with cognitive disabilities.
- They can be difficult to remember, making it harder for users to return to the publication in the future.
