...
New releases can be [created by publication owners](#create-new-release) or via requests to the [Explore Statistics Mailbox](mailto:explore.statistics@education.gov.uk). If you're requesting a new release via the mailbox, please give the following:

+ Name of the publication (including theme and topic that it sits under)
+ Time period for the release
+ [Time identifier](../creating-statistics/ud.html#List_of_allowable_time_values) for the release
