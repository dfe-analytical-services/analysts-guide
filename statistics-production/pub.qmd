...
We [recommend that teams use R Shiny](../publishing-statistics/dashboards.html#software-choices) to build and publish dashboards. Shiny applications are easily made accessible, and underlying code for Shiny apps can be published alongside for transparency.

For more information on publishing dashboards, including template code and how to get started, see our [Public dashboards page](../publishing-statistics/dashboards.html).
