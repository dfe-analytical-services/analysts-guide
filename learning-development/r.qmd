...
As with sending a SQL script, you'll need to create the connection to the database as in the previous example and then create piped queries as you would with dplyr:
...
To round numbers upwards in a way that is consistent with SQL and other programming languages, you can create a custom function like the one below:

``` {r round_five_up, eval=FALSE}
