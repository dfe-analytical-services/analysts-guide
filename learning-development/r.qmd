...
Tips for reaching best practice in R can be found on our [RAP for Statistics page](../RAP/rap-statistics.html#Clean_final_code), with guidance on meeting best practice in RAP for clean final code. This makes it easier to read and pick up if another person is running your code. 
