...
::: {.callout-tip}
## Git DevOps Manual
[Link Here] (https://dfe-analytical-services.github.io/azure-devops-for-analysis/index.html)
:::
...
- We also have a number of helpful sections on using git in practice at the end of our [RAP for Statistics page](../RAP/rap-statistics.html#version-control-with-git).
