...
| Familiarising with R | Anyone wanting to brush up on R | \~22 hours |
...
### Track 8: familiarising with R

**Estimated total duration**: \~22 hours

| Course | Description | Duration | Link |
|-----------------|--------------------|-----------------|-----------------|
| Introduction to R | Learn R basics, data types, and operations. | 4h | [Link](https://app.datacamp.com/learn/courses/free-introduction-to-r) |
| Intermediate R | Build on your R skills with loops, conditionals, and functions. | 6h | [Link](https://app.datacamp.com/learn/courses/intermediate-r) |
| Introduction to Writing Functions in R | Learn how to write reusable functions in R. | 4h | [Link](https://app.datacamp.com/learn/courses/introduction-to-writing-functions-in-r) |
| Introduction to Statistics in R | Use basic statistical concepts and analysis in R. | 4h | [Link](https://app.datacamp.com/learn/courses/introduction-to-statistics-in-r) |
| Introduction to the Tidyverse | Learn data manipulation and visualization using dplyr and ggplot2. | 4h | [Link](https://app.datacamp.com/learn/courses/introduction-to-the-tidyverse) |
